...
public interface SysApprovalInstanceMapper extends BaseMapper<SysApprovalInstance> {
    ...
    SysApprovalInstance selectByBusiness(@Param("businessType") String businessType, @Param("businessId") Long businessId);
    ...
    List<SysApprovalInstance> selectByApplicantId(Long applicantId);
     ...
     * @return 审批实例列表
     */
    List<SysApprovalInstance> selectPendingByNodeIds(@Param("nodeIds") List<Long> nodeIds);
