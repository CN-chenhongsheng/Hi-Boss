...
public class SysCheckOutController extends BaseCrudController<CheckOutVO, CheckOutQueryDTO, CheckOutSaveDTO> 
        implements BatchDeleteController {

    private final SysCheckOutService checkOutService;
